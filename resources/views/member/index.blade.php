        ...
        <div class="box">
            <div class="box-header with-border">
                {{-- <div class="btn-group"> --}}
                    ...
                    <button onclick="cetakMember('{{ route('member.cetak_member') }}')" class="btn bg-teal btn-xs btn-flat"><i class="fa fa-id-card"></i> Cetak Kartu</button>
                {{-- </div> --}}
    ...
    <script>
        ...
        $(function(){
            ...
            table = $('.table').DataTable({
                ...
                autoWidth : false,
                ajax : {
                    url : '{{ route('member.data') }}', //memperoleh data melalui route yg sudah dibuat
                },
                columns : [
        ...
        function editForm(url){
            ...
            .done((response) => {
                ...
                $('#modal-form [name=nama_member]').val(response.nama);
