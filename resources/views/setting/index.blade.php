    ...
    $(function () {
        ...
        $('.form-setting').validator().on('submit', function (e) {
            if (! e.preventDefault()) {
                ...
                .fail(errors => {
                    swal.fire('Terjadi Kesalahan!',errors.responseJSON,'error');
                    return;
                });
            }
        });
    ...
    function showData() {
        $.get('{{ route('setting.show') }}')
            .done(response => {
                ...
                // tampilkan perubahan langsung begitu disave
            ...
            .fail(errors => {
                swal.fire('Terjadi Kesalahan!','Tidak dapat menampilkan data','error');
                return;
            });
    }
</script>
