...
<body>
    ...
    <table class="data" width="100%">
        ...
        <tfoot>
            ...
            {{-- <tr>
                <td colspan="6" class="text-right"><b>Diskon Produk </b></td>
                <td class="text-right"><b>Rp. {{ format_uang($totaldiskon)}}</b></td>
            </tr> --}}
            <tr>
                <td colspan="6" class="text-right"><b>Diskon Member </b></td>
                <td class="text-right"><b>Rp. {{ format_uang($diskonrp)}}</b></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="text-right">Rp. <b>{{ format_uang($penjualan->diterima) }}</b></td>
            </tr>
            <tr>
